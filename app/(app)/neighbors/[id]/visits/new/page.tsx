...
import { createVisit } from "@/app/(app)/neighbors/actions";
...
export default async function NeighborNewVisitPage({
  params,
  searchParams,
}: {
  ...
  return (
    <div className="mx-auto max-w-lg space-y-6">
      <div>
        ...
        <h3 className="mt-2 text-sm font-medium text-foreground">Log a visit</h3>
        <p className="mt-1 text-sm text-muted">Record a visit for {neighbor.full_name}.</p>
      </div>
      ...
      <form
        action={createVisit.bind(null, id)}
